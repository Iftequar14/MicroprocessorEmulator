...
/**
 * Created by Mohammed Imtiaz Uddin on 15-Aug-16.
 */
public class ADI {
    ...
    public static void execute(String data) throws Exception {
        if (data.length() == 2 && MyHex.invalidate(data)){
            EmulatorFragment.reg[0] = Integer.toHexString(Integer.parseInt(EmulatorFragment.reg[0], 16) + Integer.parseInt(data, 16));
        } else {
